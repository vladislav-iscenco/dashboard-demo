...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildUserMenu() {
        ...
        updateUserName(null);
        settingsItem.addItem("Edit Profile",
                item -> ProfilePreferencesWindow.open(user, false));
        settingsItem.addItem("Preferences",
                item -> ProfilePreferencesWindow.open(user, true));
        settingsItem.addSeparator();
        settingsItem.addItem("Sign Out",
                item -> DashboardEventBus.post(new UserLoggedOutEvent()));
        return settings;
    }
    ...
    public final class ValoMenuItemButton extends Button {
        ...
        public ValoMenuItemButton(final DashboardViewType view) {
            ...
            setCaption(StringUtils.upperCase(viewName));
            DashboardEventBus.register(this);
